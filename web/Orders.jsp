                        ...
                        <tbody>
                            <c:forEach var="item" items="${orders}">
                                ...
                                <tr valign="top">
                                    ...
                                    <td>
                                        <a href="ShowOrderDetail?orderID=${item.ID}"class="btn" > <span>Detail</span></a>
                                        <a href="CancelOrder?orderID=${item.ID}" class="btn" ><span>Cancel</span></a>                                     
                                    </td>
                                    <td>
                                        <a href="DeleteOrder?orderID=${item.ID}"><i class="material-icons"  title="Delete">&#xE872;</i><span></span></a>
                                    </td>
                                </tr>
                            </c:forEach>
