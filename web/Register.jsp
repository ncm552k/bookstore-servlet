...
<html>
    ...
    <body>
        ...
        <div class="container">
            ...
            <form id="signup" action="UserRegisterServlet" method="POST">
                ...
                <div class="inputs">
                    ...
                    <input type="text" placeholder="User" name="user" value="${account.user}" />    <span style="color: red"><i>${eUser}</i></span>
                    <input type="password" placeholder="Password" name="password" />    <span style="color: red"><i>${ePassword}</i></span>
